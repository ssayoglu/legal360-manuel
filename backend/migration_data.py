...
BLOG_POSTS_DATA = [
    ...
    },
    {
        ...
        "excerpt": "Ceza davalarında etkili savunma yöntemleri ve haklarınızı koruma stratejileri.",
        "content": "Ceza hukuku alanında karşılaşabileceğiniz durumlar ve bu süreçte haklarınızı en iyi şekilde koruyabilmek için bilinmesi gerekenler...",
        "author": "Av. Ahmet Kaya",
        "featured_image": None,
        "tags": ["ceza hukuku", "savunma", "hukuki rehber"],
        "category": "Ceza Hukuku",
        "is_published": True,
        "meta_description": "Ceza hukuku süreçlerinde etkili savunma stratejileri"
    },
    {
        "title": "İcra ve İflas Hukuku Rehberi",
        "slug": "icra-ve-iflas-hukuku-rehberi",
        "excerpt": "İcra takibi ve iflas süreçlerinde bilmeniz gereken temel hukuki bilgiler.",
        "content": "İcra ve iflas hukuku kapsamında alacağınızı nasıl tahsil edebileceğiniz ve borçlu olduğunuz durumlarda haklarınızı nasıl koruyabileceğiniz...",
        "author": "Av. Fatma Çelik",
        "featured_image": None,
        "tags": ["icra hukuku", "iflas", "borç"],
        "category": "İcra Hukuku",
        "is_published": True,
        "meta_description": "İcra ve iflas süreçlerinde hukuki rehber"
    }
]
...
SUPREME_COURT_DECISIONS_DATA = [
    {
        ...
        "case_type": "Boşanma",
        "summary": "Anlaşmalı boşanma davalarında mal rejimi ve velayet konularına ilişkin Yargıtay kararı",
        "content": "Dava, taraflar arasındaki anlaşmalı boşanma talebine ilişkindir. Mahkemece, tarafların anlaşması doğrultusunda boşanma kararı verilmiş, ancak mal paylaşımı konusunda eksik değerlendirme yapılmıştır...",
        "keywords": ["anlaşmalı boşanma", "mal rejimi", "velayet", "nafaka"],
        "legal_basis": "TMK m. 166, 185",
        "category": "Medeni Hukuk",
        "precedent_value": "Yüksek",
        "is_published": True,
        "tags": ["boşanma", "mal paylaşımı", "velayet"]
    },
    {
        ...
        "case_type": "İş Kazası",
        "summary": "İş kazasında işverenin sorumluluğu ve tazminat hesaplanmasına ilişkin karar",
        "content": "Davacı işçinin iş kazası geçirmesi sonucu oluşan zararlarının tazmini için açılan davada, işverenin iş güvenliği yükümlülüklerini yerine getirmediği tespit edilmiştir...",
        "keywords": ["iş kazası", "işveren sorumluluğu", "tazminat", "iş güvenliği"],
        "legal_basis": "İK m. 77, 78, BK m. 49",
        "category": "İş Hukuku",
        "precedent_value": "Orta",
        "is_published": True,
        "tags": ["iş kazası", "tazminat", "işveren sorumluluğu"]
    },
    {
        "decision_number": "2024/9101",
        "court_chamber": "4. Ceza Dairesi",
        "decision_date": "2024-05-10",
        "case_type": "Dolandırıcılık",
        "summary": "İnternet üzerinden dolandırıcılık suçu ve cezai sorumluluğa ilişkin karar",
        "content": "Sanığın internet üzerinden sahte satış ilanları vererek vatandaşları dolandırdığı olayda, suçun niteliği ve cezai sorumluluğa ilişkin değerlendirmeler...",
        "keywords": ["dolandırıcılık", "internet suçları", "sahte ilan", "cezai sorumluluk"],
        "legal_basis": "TCK m. 157, 158",
        "category": "Ceza Hukuku",
        "precedent_value": "Yüksek",
        "is_published": True,
        "tags": ["dolandırıcılık", "internet suçları", "ceza"]
    }
]
