...
const mockBlogPosts = [
  {
    id: 1,
    title: "2024 Yılında Aile Hukuku Değişiklikleri",
    excerpt: "Yeni yılda aile hukuku alanında yapılan önemli değişiklikler ve bunların vatandaşlara etkileri hakkında detaylı bilgi.",
  ...
  {
    id: 2,
    title: "İş Kanunu'nda Yeni Düzenlemeler",
    excerpt: "İşçi hakları ve işveren yükümlülükleri konusunda güncel gelişmeler ve pratik öneriler.",
    category: "İş Hukuku",
  ...
  {
    id: 3,
    title: "Miras Hukuku Rehberi",
    excerpt: "Miras işlemlerinde dikkat edilmesi gereken noktalar ve sık karşılaşılan sorunlar.",
  ...
  {
    id: 4,
    title: "Ceza Hukuku'nda Güncel Gelişmeler",
    excerpt: "Ceza hukuku alanındaki son değişiklikler ve mahkeme kararları hakkında analiz.",
  ...
  {
    id: 5,
    title: "İcra ve İflas Hukuku Pratik Bilgiler",
    excerpt: "Alacak tahsili süreçlerinde bilinmesi gereken temel kurallar ve uygulamalar.",
  ...
  {
    id: 6,
    title: "Hukuki Danışmanlık Hizmetleri",
    excerpt: "Hukuki danışmanlık alırken dikkat edilmesi gereken noktalar ve doğru avukat seçimi.",
    category: "Genel",
...
const BlogPage = () => {
  ...
  // Mock data fallback
  const blogPosts = apiBlogPosts || mockBlogPosts;
