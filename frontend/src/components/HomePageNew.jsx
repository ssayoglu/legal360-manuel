...
import { ArrowRight, Scale, Users, BookOpen, Shield, Smartphone, Clock, TrendingUp, HelpCircle, Phone, Search } from 'lucide-react';
...
const HomePageNew = () => {
  ...
  const processStats = [
    { 
      number: "8+", 
      label: "Hukuki Süreç",
      description: "Boşanma, Miras, İş Davası ve daha fazlası"
    },
    { 
      number: "35+", 
      label: "Detaylı Adım",
