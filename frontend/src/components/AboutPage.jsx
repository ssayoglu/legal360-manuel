...
import { useAboutPageContent } from '../hooks/useApi';
import AdBanner from './AdBanner';

const AboutPage = () => {
  const { data: aboutContent, loading, error } = useAboutPageContent();
  
  // Default values if data is not loaded yet
  const content = aboutContent || {
    hero_title: "Hakkımızda",
    hero_description: "Legal Design Turkey olarak, karmaşık hukuki süreçleri vatandaşların kolayca anlayabileceği görsel formatlara dönüştürüyoruz.",
    mission_title: "Misyonumuz",
    mission_description: "Hukuki süreçleri görselleştirerek, vatandaşların hukuki haklarını öğrenmesini ve adalete erişimini kolaylaştırmak.",
    vision_title: "Vizyonumuz",
    vision_description: "Türkiye'de hukuki bilgilere erişimde öncü platform olmak.",
    values: [],
    team_members: []
  };
  ...
  const team = content.team_members && content.team_members.length > 0 ? content.team_members : defaultTeam;

  usePageTitle('Hakkımızda – Legal Design Turkey', 'Legal Design Turkey hakkında bilgi: misyon, vizyon ve ekip.');
            ...
            <Card className="border-2 border-blue-200 hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  ...
                  <CardTitle className="text-xl text-blue-600">{content.mission_title}</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-2 border-green-200 hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  ...
                  <CardTitle className="text-xl text-green-600">{content.vision_title}</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-gray-700 leading-relaxed">
