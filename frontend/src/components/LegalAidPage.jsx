...
// Mock fallback kaldırıldı; public tamamen backend'den yüklenir

const LegalAidPage = () => {
  const navigate = useNavigate();
  const { data: apiLegalAidInfo, loading, error } = useLegalAidInfo();
  ...
  const legalAidInfo = processedApiData; // Backend required
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-amber-800">
                  <li>• Adli yardım başvurusu yapmadan önce gelir durumunuzu belgeleyin</li>
                  <li>• Acil durumlarda 175'i arayarak hemen bilgi alabilirsiniz</li>
                  <li>• Barolar genellikle hafta içi 09:00-17:00 saatleri arasında hizmet verir</li>
                  <li>• Adli yardım almak için vatandaşlık şartı yoktur, ikamet yeterlidir</li>
                </ul>
              </div>
            </div>
          </div>
