...
import { Heart, Home, Briefcase, Scale, Clock, TrendingUp, Users, DollarSign, Filter, ChevronDown, MoreHorizontal, Search } from 'lucide-react';
...
const ProcessListNew = () => {
  ...
  usePageTitle('Hukuki Süreçler – Legal Design Turkey', 'Hukuki süreç kütüphanesi: boşanma, miras, iş ve ceza süreçleri.');

  const legalProcesses = apiProcesses || [];
            ...
            <div className="w-full sm:w-auto sm:ml-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full sm:w-72 pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
          </div>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="text-right">
                        <Badge variant="outline" className="mb-1 text-xs">
                          {(process.steps?.length ?? process.total_steps ?? 0)} Adım
                        </Badge>
