...
const ProcessList = () => {
  ...
  if (error && !apiProcesses) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600">Süreçler yüklenemedi.</p>
        </div>
      </div>
    );
  }
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        <Badge variant="outline" className="mb-1">
                          {(process.totalSteps ?? process.total_steps ?? 0)} Adım
                        </Badge>
                  ...
                  <CardContent className="pt-0">
                    ...
                    {/* Cost Range */}
                    {(process.estimatedCosts || process.estimated_costs) && (
                      <div className="bg-gray-50 p-3 rounded-lg mb-4">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <Badge variant="outline" className="text-orange-700">
                            {(process.estimatedCosts?.totalRange) || (process.estimated_costs?.total_range) || '-'}
                          </Badge>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span>{(process.totalSteps ?? process.total_steps ?? 0)} adım içerir</span>
                      </div>
