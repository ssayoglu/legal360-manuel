...
## ♻️ Değişiklik Günlüğü (7 Eylül 2025)

- Public frontend mock bağımlılıkları kaldırıldı; tüm veriler backend API'lerinden çekiliyor.
- `SupremeCourtDecisionsAdmin.jsx` alan adları backend şemasıyla hizalandı; boş değerlerin overwrite etmesi engellendi.
- Backend admin karar güncellemesinde boş string/list/dict değerleri yok sayma kuralı eklendi.
- `README.md`'ye mock verilerin yalnızca demo/test amaçlı olduğuna dair not eklendi.
